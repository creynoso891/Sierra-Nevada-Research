...
# create excel file- files will be saved to working directory with the name of each HOBO unit
...
rm(month_set) # keeing a clean environment
...
rm(measurement_set) # keeing a clean environment
